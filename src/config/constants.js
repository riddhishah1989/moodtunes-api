...
export const GENRES = [
  ...
  { name: "Classical",        emoji: "🎻", description: "Western orchestral and piano" },
  ...
  { name: "Indian Classical", emoji: "🪕", description: "Hindustani and Carnatic classical" },
  ...
  { name: "Devotional",       emoji: "🕉️", description: "Indian devotional and bhajans" },
  ...
  { name: "Bengali",          emoji: "🎸", description: "Bengali Rabindra Sangeet and pop" },
  { name: "Rajasthani Folk",  emoji: "🪘", description: "Traditional Rajasthani folk music" },
  { name: "Indie Indian",     emoji: "🌿", description: "Independent Indian artists" },
  // Asian
  ...
  { name: "Malay Pop",        emoji: "🌙", description: "Malaysian and Indonesian pop" },
  // African & Global
  ...
  // Chill & Mood
  { name: "Lo-Fi",            emoji: "☕", description: "Chill lo-fi beats to study/relax" },
  { name: "Chillout",         emoji: "🌊", description: "Relaxing downtempo music" },
  { name: "Meditation",       emoji: "🧘", description: "Meditation and mindfulness music" },
...
export const PASSWORD_ERROR = "Password must be at least 8 characters with 1 uppercase, 1 lowercase, 1 number, and 1 special character. No spaces allowed.";
